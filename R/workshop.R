...
#'  @seealso The function uses the 'data' function to load the 'GI' data set and 
#'    then uses the 'write.csv' function to write it to a file. It then launches the workshop html index 
#'    using the 'vignete' function. 
