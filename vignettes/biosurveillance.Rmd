...
Try downloaded the data directly from <http://www.google.org/flutrends/us/data.txt> using `read.csv' and then constructing a map of the most recent Google Flu Trends data. 
...
This will not install any vignettes which is why I didn't use this method for this workshop, but you could 
