...
### <a name="excel">Reading an Excel xlsx file into R</a>
...
The `haven` package provids functionality to read in SAS, Stata, and SPSS files. 
...
When you have completed the activity, compare your results to the [solutions](01_intro-solution.html#read).
...
## <a name="subsetting">Subsetting the data</a>
...
GI_AbdPain2 = subset(GI, chief_complain == "Abd Pain")
...
When you have completed the activity, compare your results to the [solutions](01_intro-solution.html#descriptive).
...
Here we focus on the graphical options for the base package in R. 
Later we will use the ggplot2 package:
...
When you have completed the activity, compare your results to the [solutions](01_intro-solution.html#graphical).
