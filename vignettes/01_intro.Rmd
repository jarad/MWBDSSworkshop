...
In R/RStudio, open the module called `01_intro.R` and scroll down to the 
`workshop()` command. From here on out, as I run commands you should run the 
...
### <a name="excel">Read Excel xlsx file</a>
...
Reading an Excel xlsx file into R is done using the `read.xlsx` function from 
the [xlsx](http://cran.r-project.org/web/packages/xlsx/index.html) R package. 
