...
- does not run [`make.names`](https://stat.ethz.ch/R-manual/R-devel/RHOME/library/base/html/make.names.html) on the column names
- does not convert character columns to factors



### <a name="excel">Read Excel files</a>
