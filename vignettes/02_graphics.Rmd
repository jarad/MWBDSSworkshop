...
When you have completed the activity, compare your results to the [solutions](02_graphics-solution.html#matrix).
...
If the above didn't work, try changing your working directory and running it again. If that didn't work run the following first, then retry. 
...
Although you can change this behavior by setting `stringsAsFactors=FALSE`.
...
When you have completed the activity, compare your results to the [solutions](02_graphics-solution.html#factor).




# <a name="reshaping">Reshaping data frames in R</a>
...
```{r}
ddply(m,                  # We need to use the melted (long) version of the data set
...
When you have completed the activity, compare your results to the [solutions](02_graphics-solution.html#aggregate).
...
Although I still use this for producing quick plots, I invariably end up using the `ggplot2` package.
...
If you are just starting out with R, I recommend using the `ggplot` function in `ggplot2` from the beginning.
...
When you have completed the activity, compare your results to the [solutions](02_graphics-solution.html#ggplot2).




# <a name="customizing">Customizing ggplot2 plots</a>
...
But it is probably easier to just google it, e.g. <http://www.cookbook-r.com/Graphs/Shapes_and_line_types/>.
