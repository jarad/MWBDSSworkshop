...
MWBDSSworkshop::workshop()   # write the files (and open up the workshop outline)
```
...
You can change this behavior by setting `stringsAsFactors = FALSE` and
...
package. 
To convert from dates to MMWR weeks, check out the 
[MMWRweek](https://cran.r-project.org/web/packages/MMWRweek/index.html)
package. 
