...
### Converting back to the original factor

To obtain the original levels of the factor use `as.character()` and `as.numeric()`

```{r}
as.character(GI$facility)             # This returns the levels as a character vector
as.numeric(GI$facility)               # This returns the numeric encoding
as.numeric(as.character(GI$facility)) # This returns the original numeric factor levels
```
