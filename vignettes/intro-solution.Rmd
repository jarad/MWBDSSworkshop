...
workshop(write_data = c("GI","fluTrends"), 
         write_scripts=NULL, 
         launch_index=FALSE)
```
...
Read in the `fluTrends.txt` file directly from its URL.

```{r}
# Read in the txt file directly from its URL
fluTrends2 = read.csv('http://www.google.org/flutrends/us/data.txt',
                      skip = 11,
                      check.names=FALSE)
all.equal(fluTrends, fluTrends2)
```
